...
{
    /// <summary>
    /// Potentially an intended improvement for the UI in selecting master 
    /// client and receiving client functionality. Not documented though. 
    /// Script kept for archival purposes only.
    /// </summary>
