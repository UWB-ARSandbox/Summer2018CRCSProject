...
namespace ASL.UI.Menus.Scanning
{
#if UNITY_EDITOR
    /// <summary>
    /// Handles the generation of an Editor window that manages Room Scanning,
    /// Saving, and Loading for the Google Tango AR Phone. Also handles all
    /// logic associated with the window.
    /// </summary>
    public class RoomSave : EditorWindow
    {
        ...
        /// <summary>
        /// The text that makes up a file used as the flag that a directory is 
        /// a Tango room save.
        /// </summary>
        public string TangoRoomDirectoryTag = "Tango";
        #endregion
        ...
        /// <summary>
        /// List of room names saved and available for loading.
        /// </summary>
        ...
        private void TagTangoRoomDirectory()
        {
            ...
            File.WriteAllText(tagPath, TangoRoomDirectoryTag);
        }
        ...
        private bool IsTangoRoomDirectory(DirectoryInfo dirInfo)
        {
            ...
            if (File.Exists(tagPath))
            {
                ...
                if (tag.Equals(TangoRoomDirectoryTag))
                {
                    return true;
                }
                else
