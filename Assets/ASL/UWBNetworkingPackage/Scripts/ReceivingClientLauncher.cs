...
namespace UWBNetworkingPackage
{
    ...
    public abstract class ReceivingClientLauncher : Launcher
    {
        ...
        /// <summary>
        /// A timestamp of the last time the receiving client launcher got a 
        /// Hololens room update. Used for previous implementation of the 
        /// Hololens room mesh transfer.
        /// </summary>
        private DateTime lastRoomUpdate = DateTime.MinValue;

        /// <summary>
        /// A timestamp of the last time the receiving client launcher was updated.
        /// </summary>
        private DateTime _lastUpdate = DateTime.MinValue;
        
        /// <summary>
        /// The threads associated with the Tango Database for this client node.
        /// Should be moved to the Scanning namespace and folder.
        /// </summary>
        List<Thread> threads = new List<Thread>(); //List of thread that manage TCP conncetions

        /// <summary>
        /// For requesting rooms from the master client.
        /// </summary>
        ...
        /// <summary>
        /// Used to see if a Tango room request has finished.
        /// </summary>
        ...
        /// <summary>
        /// Unity method that is called every frame. Handles TangoDatabase 
        /// updates.
        /// </summary>
        ...
        /// <summary>
        /// After connect to master server, join the room that's specify 
        /// by Laucher.RoomName.
        /// 
        /// NOTE: Implemented by previous ASL team. See if we can remove the
        /// requirement to have people hard-write the room name in the Editor.
        /// </summary>
...
//#endif
        ...
        /// <summary>
        /// Cleans up the threads upon application end to avoid hanging threads.
        /// </summary>
        ...
        /// <summary>
        /// Implemented by previous ASL team.
        /// 
        /// NOTE: Should not exist in this class, but in a networking 
        /// class. Move out and remove from this class.
        /// </summary>
        /// 
        /// <returns>
        /// The local IPAddress.
