...
{
    /// <summary>
    /// This class handles all configurations related to ASL. This class has many
    /// sub-classes that specify a given platform or item of interest. These
    /// sub-classes contain methods that make it easy to retrieve the names, paths,
    /// or information that would be relevant for a given item in a given context.
    /// </summary>
    public class Config : Config_Base
    {
        ...
        /// <summary>
        /// Triggers appropriate static constructors. Can't be run by ASL on
        /// startup through Unity so it must be explicitly called by a class like
        /// NetworkManager that is guaranteed to be available on startup.
        /// </summary>
        /// 
        /// <param name="platform">
        /// The type of platform this ASL node is (e.g. Windows PC, Android, etc.).
        /// </param>
        ...
        /// <summary>
        /// Current is a shortcut class. It has the exact same functionality as 
        /// the specified class but makes it so that you don't have to split 
        /// functionality in your code depending on which platform you code on. 
        /// Current correctly determines which Config sub-class to gather 
        /// information from based on the cached platform registered for this 
        /// ASL node.
        /// </summary>
        ...
        /// <summary>
        /// Use for Android-specific paths and names.
        /// </summary>
        ...
        /// <summary>
        /// Use for Hololens-specific paths and names.
        /// </summary>
        ...
        /// <summary>
        /// Use for Oculus-specific paths and names.
        /// </summary>
        public class Oculus
        {
            //public Oculus()
        ...
        /// <summary>
        /// Use for Vive-specific paths and names.
        /// </summary>
        public class Vive
        {
            //public Vive()
        ...
        /// <summary>
        /// Use for PC-specific paths and names.
        /// </summary>
        public class PC
        {
            public class AssetBundle : Config_Base_AssetBundle
        ...
        /// <summary>
        /// Use for iOS-specific paths and names.
        /// </summary>
		public class iOS
		{
			public class AssetBundle : Config_Base_AssetBundle
