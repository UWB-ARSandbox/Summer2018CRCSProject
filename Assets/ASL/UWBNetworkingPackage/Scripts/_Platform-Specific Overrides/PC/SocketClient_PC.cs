...
{
    /// <summary>
    /// PC modification of the Socket Base class specific to clients.
    /// </summary>
    public class SocketClient_PC : Socket_Base_PC
    {
        ...
        /// The filepaths associated with the files you want to sent out.
        /// </param>
        ...
        #region IGNORE! Personal testing - archived code safe for deletion
