...
{
    /// <summary>
    /// Launcher is an abstract class that contains the base functionality 
    /// needed for any device to connect to a Game Room via Photon Unity 
    /// Networking. 
    /// </summary>
    public abstract class Launcher : Photon.PunBehaviour
    {
        ...
        /// <summary>
        /// The version of the Photon Unity Networking library that is being
        /// used for the networking. Allows clients to determine if an update 
        /// is needed for proper synchronization.
        /// </summary>
        private static string _version = "1";   // Should be set to the current version of your application 

        /// <summary>
        /// Timestamp of the last update. Used for determining when a room 
        ...
        /// <summary>
        /// A cached copy of what the last registered platform for this client
        /// node is.
        /// </summary>
        ...
        /// <summary>
        /// Used as a temporary means for accessing the ASL network's 
        /// appropriate port for Tango room communication.
        /// 
        ...
        // Needed for Photon 
        /// <summary>
        /// Used as a temporary means for accessing the PUN room that the ASL 
        /// network is housed in.
        /// 
        /// Should be phased out.
        /// </summary>
        ...
        /// <summary>
        /// Implemented by previous ASL team. Was used to cache an asset bundle 
        /// for room communication.
        /// </summary>
        ...
        /// when this class is enabled. Sets Photon network settings, as well 
        /// as PUN room name and port.
        /// </summary>
        ...
        /// <summary>
        /// Unity method that triggers before any other method. Begins 
        /// connecting to the Photon server for the specified Room Name.
        /// 
        /// NOTE: Implemented by previous ASL team. Placement in Start method 
        /// triggers connection before Photon settings are set in the Awake 
        /// method. Fix this.
        /// </summary>
        ...
        /// <summary>
        /// Unity method that is called every frame. Currently doesn't do 
        /// anything.
        /// </summary>
        ...
        /// <summary>
        /// Calls the appropriate logic for synchronizing scenes.
        /// </summary>
        ...
        /// <summary>
        /// Requests all asset bundles containing Hololens scanned rooms 
        /// from the RoomTexture submodule to update the local cache.
        /// 
        /// NOTE: This should be updated and moved away from Launcher. Though 
        /// Launcher serves as the basis for all Launcher classes in ASL, Room 
        /// synchronization is strictly Scanning and belongs in that namespace.
        /// </summary>
        [PunRPC]
        ...
        /// <summary>
        /// Deletes local copy of the Hololens scanned room mesh and associated information.
        /// 
        /// NOTE: This should be updated and moved away from Launcher. Though
        /// Launcher serves as the basis for all Launcher classes in ASL, Room
        /// synchronization is strictly scanning and belongs in that namespace.
        ...
        #region TangoRPC
        /// <summary>
        /// Handles sending of the Tango Mesh to other clients.
        /// </summary>
        [PunRPC]
        ...
        /// <summary>
        /// Handles sending of the Tango Mesh to a specific client.
        /// </summary>
        /// 
        /// <param name="id">
        /// The PUN member ID to send the Tango Room Mesh to.
        /// </param>
        [PunRPC]
        ...
        /// <summary>
        /// Handles sending of the Tango Mesh to a specific port given a
        /// network configuration string.
        /// </summary>
        /// 
        /// <param name="networkConfig">
        /// A string representing the IP address and port of the intended
        /// receiving client.
        /// </param>
        [PunRPC]
        ...
        /// <summary>
        /// Handles reception of the Tango Mesh of a certain size from a given 
        /// PUN member.
        /// </summary>
        /// 
        /// <param name="id">
        /// The ID of the PUN member sending the Tango Room.
        /// </param>
        /// <param name="size">
        /// The size of the byte array of the Tango Room.
        /// </param>
        [PunRPC]
        ...
        /// <summary>
        /// Sends a specific Tango Mesh by its name.
        /// </summary>
        /// 
        /// <param name="networkConfig">
        /// A string representing the IP address and port of the intended
        ...
        /// <summary>
        /// Receive information related to a tango room.
        /// </summary>
        /// 
        /// <param name="data">
        /// Data of the tango room in string form.
        /// </param>
        [PunRPC]
        ...
        /// <summary>
        /// Send information related to a Tango Room.
        /// </summary>
        /// 
        /// <param name="ID">
        /// PUN member ID to send the information to.
        /// </param>
        [PunRPC]
        ...
        /// <summary>
        /// NOTE: Implemented by previous ASL team. No longer used and kept for 
        ...
        /// <summary>
        /// Joins the specified Room Name if already connected to the Photon 
        /// Network; otherwise, connect to the master server using the current 
        /// version number.
        /// </summary>
