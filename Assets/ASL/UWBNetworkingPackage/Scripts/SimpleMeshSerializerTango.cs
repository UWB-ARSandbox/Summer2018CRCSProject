...
namespace NetworkingPackage {
    /// <summary>
    /// A simple mesh serializer used to ferry a mesh from the Google Tango AR 
    /// phone to the PC client. Allows you to read and write vertices, triangle 
    /// indices, and vertex color values. Serialization and deserialization are
    /// supported. Header reading and writing are supported.
    /// </summary>
