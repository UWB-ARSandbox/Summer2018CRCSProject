...
namespace ASL.Manipulation.Controllers.Vive
{
    ...
    /// archiving purposes.
    /// 
    /// Currently not tested or used. A behavior similar to Selection that 
    /// handles the backend of synchronized object locking through PUN. 
    /// Not an example of controller behavior.
    /// 
