...
public class RCBehavior_TCP : MonoBehaviour
{
    ...
    public bool Use_VR_Controller;
    public double debug_x;
    public double debug_y;
    ...
    void Update()
    {
        GameObject z = GameObject.FindGameObjectWithTag("Finish");
        if (z == null)
        {
            Debug.Log("Z is null");
        } else
        {
            //Debug.Log("Z is not null");
        ...
        if (z.GetComponent<TrackpadComs>().Grip_Pressed && !Grip_Clicked)
        {
            ...
            Grip_Clicked = true;
            GameObject player = GameObject.FindGameObjectWithTag("Respawn");
            GameObject seat = GameObject.FindGameObjectWithTag("Driver Seat");
            //player.transform.position = seat.transform.position;
            player.transform.position = new Vector3(-42.7f, - 48.6f, - 34.2f);
        }
    ...
    */
    ...
    void touchpadDrive()
    {
       // Debug.Log("Running RC touchpad code");
        double x = debug_x;
        double y = debug_y;
         if (x < -0.5)
        {
